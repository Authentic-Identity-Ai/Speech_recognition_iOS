    ...
    voiceOverlayController.start(on: self, textHandler: { (text, final, extraInfo) in
      ...
      if final {
        ...
        Timer.scheduledTimer(withTimeInterval: 1.5, repeats: false, block: { (_) in
          ...
          //let myAttribute = [ NSAttributedStringKey.foregroundColor.rawValue: UIColor.red]
          ...
          //self.voiceOverlayController.settings.resultScreenText = myAttrString
            ...
            self.voiceOverlayController.settings.resultScreenText = NSMutableAttributedString(string: myString, attributes: strokeTextAttributes)
