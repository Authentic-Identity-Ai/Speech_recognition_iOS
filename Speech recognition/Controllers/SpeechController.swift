...
//  InstantSearch
//
//  Created by Authentic-Identity-Ai on 23/05/2018.
//
  ...
  public func startRecording(textHandler: @escaping SpeechTextHandler, errorHandler: @escaping SpeechErrorHandler) {
    requestAuthorization {[unowned self] (authStatus) in
      if authStatus {
        ...
        errorHandler(NSError(domain:"com.Authentic-Identity-Ai.speechcontroller", code:1, userInfo:[NSLocalizedDescriptionKey: errorMsg]))
      }
    }
  }
